...
//             $.getJSON("http://api.themoviedb.org/3/search/movie" + "?api_key=" + moviedbkey + "&query=" + term, function (json) {
...
//                     $.getJSON("http://api.themoviedb.org/3/movie/" + movieid + "?api_key=" + moviedbkey, function (json2) {
...
//                             if (posterpath != null) {
//                                 if (type === 'movie') {
//                                     $.backstretch("http://cf2.imgobject.com/t/p/original" + backdrop_path, {
//                                         fade: 670
//                                     });
//                                     var url = "http://cf2.imgobject.com/t/p/original" + posterpath;
//                                     $('.data').append('<h3 id="title">' + title + ' <a href="' + homepage + '"><i class="fa fa-external-link-square"></i></a> (' + released + ')</h3>' + '<a id="img" href="' + url + '"><img id="thePoster" src=http://cf2.imgobject.com/t/p/w300' + posterpath + '/></a><br>');
